...
import org.springframework.faces.mvc.RequestMappingMethodsResolver.RequestMappingAnnotation;
import org.springframework.faces.mvc.RequestMappingMethodsResolver.RequestMappingAnnotationMatch;
import org.springframework.faces.mvc.RequestMappingMethodsResolver.RequestMappingAnnotationMatchComparator;
		...
		try {
			...
			assertEquals(
					"Ambiguous handler methods mapped for HTTP path '/an/example/path/ambiguous.do': "
							+ "{public void org.springframework.faces.mvc.RequestMappingMethodsResolverTest$AmbiguousExample.ambiguous(), "
							+ "public void org.springframework.faces.mvc.RequestMappingMethodsResolverTest$AmbiguousExample.ambiguous(javax.servlet.http.HttpServletRequest)}. "
							+ "If you intend to handle the same path in multiple methods, then factor them out into a dedicated handler "
							+ "class with that path mapped at the type level!", e.getMessage());
		}
	}
