...
public class ViewScopeTests extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		EasyMock.expect(requestContext.getViewScope()).andReturn(viewScope);
	...
	public void testGetScope() throws Exception {
		assertSame(viewScope, new ViewScope().getScope());
	}
}
